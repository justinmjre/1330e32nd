				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> 1330 E 32nd Street?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 1330 E 32nd St</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
							...
							<br />
							<a href="http://maxebrdi.paragonrels.com/publink/default.aspx?GUID=308ff0f8-25fc-4d3b-987d-68031202439e&Report=Yes" class="image full"><img style="width: 100%;" src="images/compdata.jpg" /></a>
						</div>
					</section>
